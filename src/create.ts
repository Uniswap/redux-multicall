...
export function createMulticall(options?: MulticallOptions) {
  ...
  const useMultipleContractSingleData = (...args: ParamsWithoutContext<typeof _useMultipleContractSingleData>) => _useMultipleContractSingleData(context, ...args)
  const useSingleContractMultipleData = (...args: ParamsWithoutContext<typeof _useSingleContractMultipleData>) => _useSingleContractMultipleData(context, ...args)
  const useSingleContractWithCallData = (...args: ParamsWithoutContext<typeof _useSingleContractWithCallData>) => _useSingleContractWithCallData(context, ...args)
  const useSingleCallResult = (...args: ParamsWithoutContext<typeof _useSingleCallResult>) => _useSingleCallResult(context, ...args)
  const hooks = {
